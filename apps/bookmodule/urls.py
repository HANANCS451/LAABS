...
urlpatterns = [
    ...
    path('lab10/listbooks', views.list_books2, name='list_books'),
    path('lab10/addbook', views.add_book, name='add_book'),
    path('lab10/editbook/<int:id>', views.edit_book, name='edit_book'),
